// Submodule for the Caddy adapter. Kept separate so the core hazedb module
// (github.com/VeloxCoding/hazedb) stays stdlib + goccy only — core consumers
...
require (
	github.com/VeloxCoding/hazedb v0.1.43
